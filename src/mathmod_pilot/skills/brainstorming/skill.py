"""Skill entry point: brainstorming.

Requirement exploration and pipeline initialisation.
...
class BrainstormingSkill(PromptSkill):
    """Entry point for the *brainstorming* skill (S0, v2.0.0)."""
    ...
    def execute(self, inputs: dict[str, Any]) -> dict[str, Any]:
        ...
        self.logger.debug("BrainstormingSkill dispatched, inputs keys=%s", list(inputs.keys()))
        return result
