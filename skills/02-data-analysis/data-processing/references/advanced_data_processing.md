...
> `data_processing_advanced` in the examples is an interface blueprint, not a bundled
> dependency. If the workspace does not provide it, generate an equivalent task-local
> pandas/scikit-learn implementation and run it.
